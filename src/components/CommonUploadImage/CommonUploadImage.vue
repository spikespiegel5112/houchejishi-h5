<template>
  <div class="common_uploadimage_wrapper">
    ...
    <el-upload ref="uploadAvatar" :action="action" :limit='limit' :auto-upload="true" :show-file-list='showFileList'
      ...
      :list-type="isPictureCard" :multiple='multiple'>
    ...
    <el-dialog class="preview" :visible.sync="dialogVisible" :modal='false'>
      <div class="content">
...
export default {
  ...
  watch: {
    ...
    returnUrlList(value) {
      console.log('watch returnUrlList1++++++', value)
  ...
  methods: {
    ...
    checkPrefix(url) {
      // return process.env.VUE_APP_BASE_API + '/manager' + url
      return 'http://122.112.224.131:8090' + '/manager' + url
    },
